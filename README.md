# _printf  This is a prototype for the  implementation of (_printf). As you can see, this prototype is an implementation of the **printf standard function** and **variadic function** .
